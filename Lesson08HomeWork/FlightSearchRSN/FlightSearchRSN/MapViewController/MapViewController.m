...
- (void) configureMapView {
    ...
    self.title = NSLocalizedString(@"mapViewControllerTitle", "");
...
-(void)setPrices:(NSArray *)prices {
    ...
    for (MapPrice *price in prices) {
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            annotation.subtitle = [[NSString stringWithFormat:@"%ld", (long)price.value] stringByAppendingString:NSLocalizedString(@"priceLabelCurrencyUnit", "")];
