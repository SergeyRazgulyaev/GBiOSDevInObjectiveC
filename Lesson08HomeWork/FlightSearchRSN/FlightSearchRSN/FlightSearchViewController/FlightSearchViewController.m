...
- (void) configure {
    ...
    self.title = NSLocalizedString(@"flightSearchViewControllerTitle", "");
...
- (void) configureFromLabel {
    self.fromLabel = [[UILabel alloc] initWithFrame: CGRectMake(([UIScreen mainScreen].bounds.size.width - 300) / 2.0 - 24, 130, 60, 40)];
    self.fromLabel.textColor = [UIColor whiteColor];
    self.fromLabel.text = NSLocalizedString(@"flightSearchViewControllerFromLabel", "");
...
- (void) configureToLabel {
    self.toLabel = [[UILabel alloc] initWithFrame: CGRectMake(([UIScreen mainScreen].bounds.size.width - 300) / 2.0 - 8, 190, 43, 40)];
    self.toLabel.textColor = [UIColor whiteColor];
    self.toLabel.text = NSLocalizedString(@"flightSearchViewControllerToLabel", "");
...
- (void) configureFlightDurationLabel {
    self.flightDurationLabel = [[UILabel alloc] initWithFrame: CGRectMake(([UIScreen mainScreen].bounds.size.width - 300) / 2.0, 300, 300, 30)];
    self.flightDurationLabel.textColor = [UIColor whiteColor];
    self.flightDurationLabel.text = [[NSLocalizedString(@"flightDurationLabelText", "") stringByAppendingFormat:@"%@ ", [NSString stringWithFormat: @"%0.0f", 7.0]] stringByAppendingString:NSLocalizedString(@"flightDurationLabelUnits", "")];
...
- (void) configureCompleteLoadDataLabel {
    self.completeLoadDataLabel = [[UILabel alloc] initWithFrame: CGRectMake(([UIScreen mainScreen].bounds.size.width - 300) / 2.0, 430, 300, 50)];
    self.completeLoadDataLabel.textColor = [UIColor whiteColor];
    self.completeLoadDataLabel.text = NSLocalizedString(@"completeLoadDataLabelText", "");
...
-(void) configureDeparturePlaceTextField {
    self.departurePlaceTextField = [[UITextField alloc] initWithFrame: CGRectMake(([UIScreen mainScreen].bounds.size.width - 300) / 2.0 + 43, 130, 218, 40)];
    self.departurePlaceTextField.borderStyle = UITextBorderStyleRoundedRect;
    self.departurePlaceTextField.placeholder = NSLocalizedString(@"departurePlaceTextFieldPlaceholder", "");
...
-(void) configureArrivalPlaceTextField {
    self.arrivalPlaceTextField = [[UITextField alloc] initWithFrame: CGRectMake(([UIScreen mainScreen].bounds.size.width - 300) / 2.0 + 43, 190, 218, 40)];
    self.arrivalPlaceTextField.borderStyle = UITextBorderStyleRoundedRect;
    self.arrivalPlaceTextField.placeholder = NSLocalizedString(@"arrivalPlaceTextFieldPlaceholder", "");
...
- (void) configureEconomyOrBusinessSegmentedControl {
    self.economyOrBusinessSegmentedControl = [[UISegmentedControl alloc] initWithItems:@[NSLocalizedString(@"economySegmentedControl", ""), NSLocalizedString(@"businessSegmentedControl", "")]];
...
- (void) sliderValueChanged: (UISlider *)slider {
    if ([slider isEqual:self.flightDurationSlider]) {
        self.flightDurationLabel.text = [[NSLocalizedString(@"flightDurationLabelText", "") stringByAppendingFormat:@"%@ ", [NSString stringWithFormat: @"%0.0f", self.flightDurationSlider.value]] stringByAppendingString:NSLocalizedString(@"flightDurationLabelUnits", "")];
    }
}
...
- (void) configureFindDeparturePlaceButton {
    ...
    self.findDeparturePlaceButton.frame = CGRectMake(([UIScreen mainScreen].bounds.size.width - 300) / 2.0 + 270, 130, 40, 40);
...
- (void) configureFindArrivalPlaceButton {
    ...
    self.findArrivalPlaceButton.frame = CGRectMake(([UIScreen mainScreen].bounds.size.width - 300) / 2.0 + 270, 190, 40, 40);
...
- (void) configureShowTicketsButton {
    ...
    [self.showTicketsButton setTitle:NSLocalizedString(@"showTicketsButtonTitle", "") forState:UIControlStateNormal];
...
- (void) pushShowTicketsButton: (UIButton *)sender {
    ...
    if (self.searchRequest.origin == nil || self.searchRequest.destination == nil) {
        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"alertControllerInFlightSearchVCTitle", "") message:NSLocalizedString(@"alertControllerInFlightSearchVCMessage1", "") preferredStyle:UIAlertControllerStyleAlert];
        [alertController addAction:[UIAlertAction actionWithTitle:NSLocalizedString(@"alertControllerInFlightSearchVCActionClose", "") style:(UIAlertActionStyleDefault) handler:nil]];
            ...
            [[APIManager sharedInstance] ticketsWithRequest:self.searchRequest withCompletion:^(NSArray *tickets) {
                [[ProgressView sharedInstance] dismiss:^{
                    if (tickets.count > 0) {
                        ...
                        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"alertControllerInFlightSearchVCActionSorry", "") message:NSLocalizedString(@"alertControllerInFlightSearchVCMessage2", "") preferredStyle: UIAlertControllerStyleAlert];
                        [alertController addAction:[UIAlertAction actionWithTitle:NSLocalizedString(@"alertControllerInFlightSearchVCActionClose", "") style:(UIAlertActionStyleDefault) handler:nil]];
                        self->_searchRequest.origin = nil;
                        self->_searchRequest.destination = nil;
                        [self presentViewController:alertController animated:YES completion:nil];
                    }
                }];
            }];
