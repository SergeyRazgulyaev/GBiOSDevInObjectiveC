...
- (void)setTicket:(Ticket *)ticket {
    ...
    _priceLabel.text = [[NSString stringWithFormat:@"%@ ", ticket.price] stringByAppendingString:NSLocalizedString(@"priceLabelCurrencyUnit", "")];
...
- (void)setFavoriteTicket:(FavoriteTicket *)favoriteTicket {
    ...
    _priceLabel.text = [[NSString stringWithFormat:@"%lld", favoriteTicket.price] stringByAppendingString:NSLocalizedString(@"priceLabelCurrencyUnit", "")];
