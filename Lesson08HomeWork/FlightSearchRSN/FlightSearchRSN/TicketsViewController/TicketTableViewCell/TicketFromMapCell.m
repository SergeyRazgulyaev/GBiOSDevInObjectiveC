...
- (void)setMapPrice:(MapPrice *)mapPrice {
    ...
    _priceLabel.text = [[NSString stringWithFormat:@"%ld", (long)mapPrice.value] stringByAppendingString:NSLocalizedString(@"priceLabelCurrencyUnit", "")];
...
- (void)setFavoriteTicketFromMap:(FavoriteMapPrice *)favoriteTicketFromMap {
    ...
    _priceLabel.text = [[NSString stringWithFormat:@"%lld", _favoriteTicketFromMap.priceValue] stringByAppendingString:NSLocalizedString(@"priceLabelCurrencyUnit", "")];
