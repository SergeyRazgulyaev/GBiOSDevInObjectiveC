...
- (void)configureTravelDestinationsViewController {
    self.title = NSLocalizedString(@"travelDestinationsViewControllerTitle", "");
...
- (void)configureSearchController {
    ...
    self.searchController.searchBar.placeholder = NSLocalizedString(@"travelDestinationsVCsearchControllerPlaceholder", "");
