...
- (void)createContentDataArray {
    NSArray *titles = [NSArray arrayWithObjects:
                       NSLocalizedString(@"titleAboutApplication", ""),
                       NSLocalizedString(@"titleTickets", ""),
                       NSLocalizedString(@"titleMapWithPrices", ""),
                       NSLocalizedString(@"titleFavorites", ""),
                       nil];
    NSArray *contents = [NSArray arrayWithObjects:
                         NSLocalizedString(@"contentAboutApplication", ""),
                         NSLocalizedString(@"contentTickets", ""),
                         NSLocalizedString(@"contentMapWithPrices", ""),
                         NSLocalizedString(@"contentFavorites", ""),
                         nil];
    for (int i = 0; i < 4; ++i) {
...
- (void)updateButtonWithIndex:(int)index {
    switch (index) {
        ...
        case 1:
        case 2:
            [self.nextButton setTitle:NSLocalizedString(@"nextButtonTitle", "") forState:UIControlStateNormal];
            self.nextButton.tag = 0;
            break;
        case 3:;
            [self.nextButton setTitle:NSLocalizedString(@"readyButtonTitle", "") forState:UIControlStateNormal];
