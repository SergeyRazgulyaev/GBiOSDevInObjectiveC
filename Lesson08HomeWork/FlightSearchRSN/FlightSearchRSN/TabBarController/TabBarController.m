...
- (NSArray<UIViewController*> *) createViewControllers {
    ...
    //1 FinderViewController
    FinderViewController *finderViewController = [[FinderViewController alloc] init];
    finderViewController.tabBarItem = [[UITabBarItem alloc]initWithTitle:NSLocalizedString(@"finderViewControllerTitle", "") image:[UIImage systemImageNamed:@"ticket"] selectedImage:[UIImage systemImageNamed:@"ticket.fill"]];
    ...
    //2 Map ViewController
    MapViewController *mapViewController = [[MapViewController alloc] init];
    mapViewController.tabBarItem = [[UITabBarItem alloc]initWithTitle:NSLocalizedString(@"mapViewControllerTitle", "") image:[UIImage systemImageNamed:@"map"] selectedImage:[UIImage systemImageNamed:@"map.fill"]];
    ...
    //3 Favorite Tickets ViewController
    TicketsViewController *favoritesViewController = [[TicketsViewController alloc] initFavoriteTicketsController];
    favoritesViewController.tabBarItem = [[UITabBarItem alloc]initWithTitle:NSLocalizedString(@"favoritesViewControllerTitle", "") image:[UIImage systemImageNamed:@"star.circle"] selectedImage:[UIImage systemImageNamed:@"star.circle.fill"]];
    ...
    //4 AircraftFleetViewController
    AircraftFleetViewController *aircraftFleetViewController = [[AircraftFleetViewController alloc] init];
    aircraftFleetViewController.tabBarItem = [[UITabBarItem alloc]initWithTitle:NSLocalizedString(@"aircraftFleetViewControllerTitle", "") image:[UIImage systemImageNamed:@"airplane.circle"] selectedImage:[UIImage systemImageNamed:@"airplane.circle.fill"]];
