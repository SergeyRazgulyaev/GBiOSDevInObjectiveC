...
- (NSArray<UIViewController*> *) createViewControllers {
    ...
    favoritesViewController.tabBarItem = [[UITabBarItem alloc]initWithTitle:@"Favorites" image:[UIImage systemImageNamed:@"star.circle"] selectedImage:[UIImage systemImageNamed:@"star.circle.fill"]];
